...
// Interface para link de menu dinâmico
interface MenuLink {
  label: string;
  url: string;
  isExternal: boolean;
...
// Interface para coluna de menu do footer
...
const defaultMenuColumns: MenuColumn[] = [
  {
    title: 'menu',
    links: [
      { url: '/', label: 'overview', isExternal: false },
  ...
  {
    title: 'links úteis',
    links: [{ url: 'https://ufam.edu.br', label: 'portal ufam', isExternal: true }],
  },
];
...
export default function Footer({
  ...
  // Usa as colunas passadas via props, ou fallback para as padrões
  const columns = menuColumns.length > 0 ? menuColumns : defaultMenuColumns;
